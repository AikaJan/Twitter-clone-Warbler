...
# If possible (Unix), use the resource module instead of time.perf_counter()
try:
    import resource
    def clocku():
        ...
        wraparound problems in time.perf_counter()."""
    ...
    def clock():
        ...
        avoids the wraparound problems in time.perf_counter()."""
...
def timings_out(reps,func,*args,**kw):
    ...
    related to the wraparound effect which the time.perf_counter() function has.
